    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center justify-end gap-2">
        <button
          ...
          onClick={onCancel}
          disabled={deleting}
          className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg border border-border text-muted-foreground font-bold text-sm hover:bg-accent transition-colors min-h-[44px] disabled:opacity-50"
        >
          ביטול
        </button>
        <button
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="rounded-[20px] border border-destructive/30 bg-destructive/5 p-5 flex flex-col gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <ul className="text-xs text-destructive mt-1 mr-4 list-disc space-y-0.5">
      ...
      <div className="flex items-center justify-end">
        <button
          type="button"
          onClick={onClose}
          className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg border border-border text-muted-foreground font-bold text-sm hover:bg-accent transition-colors min-h-[44px]"
        >
          סגור
        </button>
      </div>
